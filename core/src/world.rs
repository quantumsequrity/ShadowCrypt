...
impl Tile {
    ...
    pub fn glyph(&self) -> char {
        match self {
            ...
            // Environmental hazards
            Self::PoisonGas => '*',
            Self::CrumblingFloor | Self::Rubble => ':',
            Self::BrokenFloor => ' ',
            Self::SporeColony => '%',
            Self::AcidPool => '~',
            Self::FrozenGround => '.',
            ...
            Self::Altar => 'A',
            Self::Sarcophagus => 'S',
            Self::Fountain | Self::BrokenFountain => '{',
            Self::Statue | Self::CrackedStatue => '&',
            Self::Brazier => '*',
            Self::UnlitBrazier => 'u',
            Self::Vines => '"',
            Self::Mushrooms | Self::GlowingMushrooms => 'm',
            Self::CrystalFormation => '*',
            Self::MineCart => 'c',
            Self::Rails => '=',
            Self::MagicCircle => '@',
            Self::LockedChest | Self::MimicChest => '=',
        }
    }
