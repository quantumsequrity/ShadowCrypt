//! ShadowCrypt GUI - Graphical frontend with advanced lighting, fog of war, and particle effects
//!
...
//! Includes comprehensive particle effects for combat, magic, and environment.

mod particles;

use eframe::egui::{self, Color32, FontId, Pos2, RichText, Rounding, Sense, Stroke, Vec2};
...
use particles::{ParticleSystem, ParticleEvent, ParticleType, process_particle_event};
...
struct ShadowCryptApp {
    ...
    /// Queued particle events
    particle_events: VecDeque<ParticleEvent>,
    /// Show particle debug info
    show_particle_debug: bool,
    /// Previous player HP for damage detection
    previous_player_hp: i32,
    /// Previous player level for level-up detection
